...
// ─── CUTE CRAWLING BABY SVG (Based on Reference Image) ────────────────────────
const AnimatedCrawlingBaby = () => (
  <svg viewBox="0 0 140 110" width="140" height="110" xmlns="http://www.w3.org/2000/svg" overflow="visible">

    {/* ── Ground shadow: scales with bounce ── */}
    <ellipse className="baby-shadow" cx="65" cy="100" rx="42" ry="5" fill="#cbd5e1" opacity="0.6"/>

    {/* ── BACK LEFT LEG (depth layer, darker pink) ── */}
    <g className="limb-leg-back">
      <path d="M 35 65 L 20 85 L 10 85" fill="none" stroke="#f07598" strokeWidth="12" strokeLinecap="round" strokeLinejoin="round"/>
      <ellipse cx="9" cy="85" rx="5" ry="4" fill="#ffcdb8" /> {/* Bare foot */}
    </g>

    {/* ── FRONT LEFT ARM (depth layer, darker pink/skin) ── */}
    <g className="limb-arm-back">
      <path d="M 70 65 L 60 85" fill="none" stroke="#f07598" strokeWidth="10" strokeLinecap="round" strokeLinejoin="round"/>
      <circle cx="60" cy="85" r="4.5" fill="#ffcdb8" /> {/* Bare hand */}
    </g>
    ...
    <g className="baby-body-group">
      <g className="body-sway">
        <g className="body-squash">
          ...
          {/* Main Pink Onesie Torso */}
          <ellipse cx="55" cy="65" rx="35" ry="22" fill="#ff8fab"/>
          {/* Cute little diaper bump/onesie fold */}
          <path d="M 25 55 Q 15 65 25 80 Q 40 85 55 85 Q 70 85 85 75 Q 90 60 80 50 Z" fill="#ff8fab" />

        </g>

        {/* ── FRONT RIGHT LEG (foreground, onesie pink + bare foot) ── */}
        <g className="limb-leg-front">
          <path d="M 45 65 L 30 90 L 15 90" fill="none" stroke="#ff8fab" strokeWidth="14" strokeLinecap="round" strokeLinejoin="round"/>
          <ellipse cx="14" cy="90" rx="5.5" ry="4.5" fill="#ffe4e1" /> {/* Bare foot */}
        </g>

        {/* ── FRONT RIGHT ARM (foreground, onesie sleeve + bare hand) ── */}
        <g className="limb-arm-front">
          <path d="M 80 65 L 90 88" fill="none" stroke="#ff8fab" strokeWidth="12" strokeLinecap="round" strokeLinejoin="round"/>
          <circle cx="90" cy="89" r="5.5" fill="#ffe4e1" /> {/* Bare hand */}
        </g>
      </g>
    </g>
    ...
    <g className="baby-head-group">
      ...
      {/* Big Round Head */}
      <circle cx="95" cy="40" r="28" fill="#ffe4e1"/>
      
      {/* Cute Ear */}
      <circle cx="68" cy="45" r="5.5" fill="#ffbfa8" />

      {/* Hair Tufts (Reference image style) */}
      <path d="M 85 12 Q 95 -2 105 10" fill="none" stroke="#2a1f1d" strokeWidth="2.5" strokeLinecap="round"/>
      <path d="M 92 10 Q 100 0 110 12" fill="none" stroke="#2a1f1d" strokeWidth="2.5" strokeLinecap="round"/>
      ...
      {/* Rosy Cheeks */}
      <ellipse cx="85" cy="52" rx="6" ry="4" fill="#ff6b8b" opacity="0.4"/>
      <ellipse cx="112" cy="52" rx="6" ry="4" fill="#ff6b8b" opacity="0.4"/>

      {/* Eye Group with blink */}
      <g className="baby-eye-group">
        {/* OPEN EYES (Huge anime style from reference) */}
        <g className="eye-open">
          {/* Left Eye */}
          <circle cx="85" cy="40" r="7.5" fill="#1e1e1e" />
          <circle cx="87" cy="37" r="2.5" fill="#ffffff" />
          <circle cx="83" cy="42" r="1" fill="#ffffff" />
          {/* Right Eye */}
          <circle cx="110" cy="40" r="7.5" fill="#1e1e1e" />
          <circle cx="112" cy="37" r="2.5" fill="#ffffff" />
          <circle cx="108" cy="42" r="1" fill="#ffffff" />
        </g>
...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 p-4 md:p-8 overflow-hidden relative">
      ...
      {/* ═══════════════════════════════════════════════════════════════════
          CRAWLING BABY — FULL PHYSICS ANIMATION SYSTEM
          ───────────────────────────────────────────────────────────────── */}
      <style>{`
        ...
        .limb-arm-front { animation: limbFwd 1.2s ease-in-out 0s infinite;     transform-origin: 80px 65px; }
        .limb-leg-front { animation: limbFwd 1.2s ease-in-out 0.05s infinite;  transform-origin: 45px 65px; }
        .limb-arm-back  { animation: limbBwd 1.2s ease-in-out 0.6s infinite;   transform-origin: 70px 65px; }
        .limb-leg-back  { animation: limbBwd 1.2s ease-in-out 0.65s infinite;  transform-origin: 35px 65px; }
